...
const App = () => {
  ...
  return (
    <div className="p-10 bg-black ">
      ...
      <section className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 my-5">
        {filtered.length === 0 ? (
          ...
          filtered.map((Country, idx) => (
            <div key={idx} className="card bg-base-100 w-full shadow-sm">
              <figure>
                <img
                  className="object-cover md:max-h-40 min-h-60 w-full"
              ...
              <div className="card-body">
                ...
                <div className="flex gap-2">
                  <div className="badge badge-outline badge-accent font-bold">
